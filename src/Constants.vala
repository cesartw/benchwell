namespace Benchwell {
	...
	public const string[] on_white = {"#ff7305", "#202329", "#9d9d9c", "#dadada", "#9dfc62", "#575756"};
	public const string[] on_dark  = {"#ff7305", "#575757", "#9d9d9c", "#ffffff", "#9dfc62", "#575756"};
	public const string[] on_main  = {"#202329", "#ffffff", "#9d9d9c", "#ffffff", "#9dfc62", "#575756"};
